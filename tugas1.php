...
<body >
    <h1 align="center">୨୧   Wisata Yogyakarta   ୨୧</h1>
    <form action="" method="post">
          ...
          <td></td>
            ...
            <tr>
                ...
                <td><select name="destinasi" id="">
                    <option selected>≡   Wisata Yogyakarta   ≡</option>
        ...
        <?php
            if(isset($_POST['proses'])){
                ...
                if($destinasi == "1"){
        ?>
                  <h2 align="center">୨୧  Bukit Bintang  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
          ...
          <?php }elseif($destinasi == "2"){ ?>
                  <h2 align="center">୨୧  Pantai Sadranan  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
          ...
          <?php }elseif($destinasi == "3"){ ?>
                  <h2 align="center">୨୧  Candi Borobudur  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
          ...
          <?php }elseif($destinasi == "4"){ ?>
                  <h2 align="center">୨୧  Candi Prambanan  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
          ...
          <?php }elseif($destinasi == "5"){ ?>
                  <h2 align="center">୨୧  Keraton Yogyakarta  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
          ...
          <?php }elseif($destinasi == "6"){ ?>
                  <h2 align="center">୨୧  Malioboro  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
         ...
         <?php }elseif($destinasi == "7"){ ?>
                  <h2 align="center">୨୧  Pendopo Lawas  ୨୧</h2>
         ...
         <tr>
                  ...
                  <div  class="cafe">
                      <center>
                        ...
                        <option value="1">1. coffee special</option>
                        <option value="2">2. teh</option>
                        <option value="3">3. teh tarik</option>
                        <option value="4">4. nasi goreng</option>
                      </select>
         </center>
         <center>
                     <input type="number" name="jumlah" placeholder="Pesan berapa" align="center">
                     <input type="number" name="bayar" placeholder="Bayar">
                     <input type="submit" name="cafe" value="OK">
                  </div>
         </center>
         <?php }elseif($destinasi == "8"){ ?>
                  <h2 align="center">୨୧  Goa Pindul  ୨୧</h2>
                  <table align="center">
                    <tr>
                      <td>Tempat</td>
                      <td>:</td>
